import { CollectionObjectIdType, CollectionObjectType, ComparisonSelectionResponse } from '../types.js';
...
type ComparisonLinkProps<CO extends CollectionObjectType<IdType>, IdType extends CollectionObjectIdType> = {
  comparison: ComparisonSelectionResponse<CO> | undefined;
};

const createComparisonUrl = <CO extends CollectionObjectType<IdType>, IdType extends CollectionObjectIdType>(
...
export const ComparisonLink = <CO extends CollectionObjectType<IdType>, IdType extends CollectionObjectIdType>({
  comparison,
